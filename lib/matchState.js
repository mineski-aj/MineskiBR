...
const DEFAULT = {
  ...
  // own time, map name (fixed BR_MAP_NAMES pool), and winning team. Today
  // and tomorrow are independent lists/counts — tomorrow's is usually
  // still being planned while today's is live.
  todayMapsCount: 5,
  todayMaps: [
    { time: '', mapName: 'Isolated', winner: '' },
    { time: '', mapName: 'Isolated', winner: '' },
    { time: '', mapName: 'Isolated', winner: '' },
    { time: '', mapName: 'Isolated', winner: '' },
    { time: '', mapName: 'Isolated', winner: '' },
