...
const state = {
  ...
  // (resets to enabled on server restart). Consulted by lib/pollers.js,
  // lib/hrmPoller.js and routes/devapi.js's proxy routes before making the
  // actual outbound request.
  apiEnabled: {
    game: true, hrm: true, postinfo: true,
    hexagon: true, highlights: true,
  },
