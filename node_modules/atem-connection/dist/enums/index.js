...
exports.SafeTitlePattern = exports.TimeMode = exports.AudioInternalPortType = exports.AudioChannelPair = exports.DisplayClockClockMode = exports.DisplayClockClockState = exports.MultiViewerLayout = exports.FairlightInputType = exports.FairlightAudioSourceType = exports.FairlightAnalogInputLevel = exports.FairlightInputConfiguration = exports.FairlightAudioMixOption = exports.RecordingDiskStatus = exports.RecordingStatus = exports.RecordingError = exports.StreamingStatus = exports.StreamingError = exports.AudioSourceType = exports.AudioMixOption = exports.MediaSourceType = exports.VideoMode = exports.VideoFormat = exports.SuperSourceArtOption = exports.FlyKeyDirection = exports.FlyKeyKeyFrame = exports.MixEffectKeyType = exports.Pattern = exports.IsAtKeyFrame = exports.BorderBevel = exports.MeAvailability = exports.SourceAvailability = exports.InternalPortType = exports.ExternalPortType = exports.MacroAction = exports.DVEEffect = exports.TransitionSelection = exports.TransitionStyle = exports.ProtocolVersion = exports.Model = void 0;
var Model;
(function (Model) {
    ...
    Model[Model["SDI"] = 21] = "SDI";
    Model[Model["SDIProISO"] = 22] = "SDIProISO";
    Model[Model["SDIExtremeISO"] = 23] = "SDIExtremeISO";
    // 0x18 ??
    // 0x19 ??
    Model[Model["TelevisionStudioHD8"] = 26] = "TelevisionStudioHD8";
    Model[Model["TelevisionStudioHD8ISO"] = 27] = "TelevisionStudioHD8ISO";
    Model[Model["Constellation4K1ME"] = 28] = "Constellation4K1ME";
    Model[Model["Constellation4K2ME"] = 29] = "Constellation4K2ME";
    Model[Model["Constellation4K4ME"] = 30] = "Constellation4K4ME";
    Model[Model["Constellation4K4MEPlus"] = 31] = "Constellation4K4MEPlus";
    Model[Model["TelevisionStudio4K8"] = 32] = "TelevisionStudio4K8";
    Model[Model["MiniExtremeISOG2"] = 33] = "MiniExtremeISOG2";
...
(function (ProtocolVersion) {
    ...
    ProtocolVersion[ProtocolVersion["V8_1_1"] = 131102] = "V8_1_1";
    ProtocolVersion[ProtocolVersion["V9_4"] = 131103] = "V9_4";
    ProtocolVersion[ProtocolVersion["V9_6"] = 131104] = "V9_6";
...
(function (TransitionSelection) {
    TransitionSelection[TransitionSelection["Background"] = 1] = "Background";
    TransitionSelection[TransitionSelection["Key1"] = 2] = "Key1";
    TransitionSelection[TransitionSelection["Key2"] = 4] = "Key2";
    TransitionSelection[TransitionSelection["Key3"] = 8] = "Key3";
    TransitionSelection[TransitionSelection["Key4"] = 16] = "Key4";
})(TransitionSelection = exports.TransitionSelection || (exports.TransitionSelection = {}));
var DVEEffect;
(function (DVEEffect) {
...
(function (ExternalPortType) {
    ...
    ExternalPortType[ExternalPortType["RJ45"] = 4096] = "RJ45";
...
(function (InternalPortType) {
    ...
    // Since v9_4/v9_6
    InternalPortType[InternalPortType["AudioMonitor"] = 132] = "AudioMonitor";
...
(function (SourceAvailability) {
    ...
    SourceAvailability[SourceAvailability["WebcamOut"] = 128] = "WebcamOut";
    SourceAvailability[SourceAvailability["All"] = 255] = "All";
...
(function (VideoFormat) {
    VideoFormat[VideoFormat["SD"] = 0] = "SD";
    VideoFormat[VideoFormat["HD720"] = 1] = "HD720";
    VideoFormat[VideoFormat["HD1080"] = 2] = "HD1080";
    VideoFormat[VideoFormat["UHD4K"] = 3] = "UHD4K";
    VideoFormat[VideoFormat["UDH8K"] = 4] = "UDH8K";
...
(function (StreamingStatus) {
    ...
    StreamingStatus[StreamingStatus["Stopping"] = 32] = "Stopping";
...
(function (MultiViewerLayout) {
    MultiViewerLayout[MultiViewerLayout["Default"] = 0] = "Default";
    MultiViewerLayout[MultiViewerLayout["TopLeftSmall"] = 1] = "TopLeftSmall";
    MultiViewerLayout[MultiViewerLayout["TopRightSmall"] = 2] = "TopRightSmall";
    MultiViewerLayout[MultiViewerLayout["ProgramBottom"] = 3] = "ProgramBottom";
    MultiViewerLayout[MultiViewerLayout["BottomLeftSmall"] = 4] = "BottomLeftSmall";
    MultiViewerLayout[MultiViewerLayout["ProgramRight"] = 5] = "ProgramRight";
    MultiViewerLayout[MultiViewerLayout["BottomRightSmall"] = 8] = "BottomRightSmall";
    MultiViewerLayout[MultiViewerLayout["ProgramLeft"] = 10] = "ProgramLeft";
    MultiViewerLayout[MultiViewerLayout["ProgramTop"] = 12] = "ProgramTop";
})(MultiViewerLayout = exports.MultiViewerLayout || (exports.MultiViewerLayout = {}));
var DisplayClockClockState;
(function (DisplayClockClockState) {
    DisplayClockClockState[DisplayClockClockState["Stopped"] = 0] = "Stopped";
    DisplayClockClockState[DisplayClockClockState["Running"] = 1] = "Running";
    DisplayClockClockState[DisplayClockClockState["Reset"] = 2] = "Reset";
})(DisplayClockClockState = exports.DisplayClockClockState || (exports.DisplayClockClockState = {}));
var DisplayClockClockMode;
(function (DisplayClockClockMode) {
    DisplayClockClockMode[DisplayClockClockMode["Countdown"] = 0] = "Countdown";
    DisplayClockClockMode[DisplayClockClockMode["Countup"] = 1] = "Countup";
    DisplayClockClockMode[DisplayClockClockMode["TimeOfDay"] = 2] = "TimeOfDay";
})(DisplayClockClockMode = exports.DisplayClockClockMode || (exports.DisplayClockClockMode = {}));
var AudioChannelPair;
(function (AudioChannelPair) {
    AudioChannelPair[AudioChannelPair["Channel1_2"] = 0] = "Channel1_2";
    AudioChannelPair[AudioChannelPair["Channel3_4"] = 1] = "Channel3_4";
    AudioChannelPair[AudioChannelPair["Channel5_6"] = 2] = "Channel5_6";
    AudioChannelPair[AudioChannelPair["Channel7_8"] = 3] = "Channel7_8";
    AudioChannelPair[AudioChannelPair["Channel9_10"] = 4] = "Channel9_10";
    AudioChannelPair[AudioChannelPair["Channel11_12"] = 5] = "Channel11_12";
    AudioChannelPair[AudioChannelPair["Channel13_14"] = 6] = "Channel13_14";
    AudioChannelPair[AudioChannelPair["Channel15_16"] = 7] = "Channel15_16";
})(AudioChannelPair = exports.AudioChannelPair || (exports.AudioChannelPair = {}));
var AudioInternalPortType;
(function (AudioInternalPortType) {
    AudioInternalPortType[AudioInternalPortType["NotInternal"] = 0] = "NotInternal";
    AudioInternalPortType[AudioInternalPortType["NoAudio"] = 1] = "NoAudio";
    AudioInternalPortType[AudioInternalPortType["TalkbackMix"] = 2] = "TalkbackMix";
    AudioInternalPortType[AudioInternalPortType["EngineeringTalkbackMix"] = 3] = "EngineeringTalkbackMix";
    AudioInternalPortType[AudioInternalPortType["ProductionTalkbackMix"] = 4] = "ProductionTalkbackMix";
    AudioInternalPortType[AudioInternalPortType["MediaPlayer"] = 5] = "MediaPlayer";
    AudioInternalPortType[AudioInternalPortType["Program"] = 6] = "Program";
    AudioInternalPortType[AudioInternalPortType["Return"] = 7] = "Return";
    AudioInternalPortType[AudioInternalPortType["Monitor"] = 8] = "Monitor";
    AudioInternalPortType[AudioInternalPortType["Madi"] = 9] = "Madi";
    AudioInternalPortType[AudioInternalPortType["AuxOut"] = 10] = "AuxOut";
    AudioInternalPortType[AudioInternalPortType["AudioAuxOut"] = 11] = "AudioAuxOut";
})(AudioInternalPortType = exports.AudioInternalPortType || (exports.AudioInternalPortType = {}));
var TimeMode;
(function (TimeMode) {
    TimeMode[TimeMode["FreeRun"] = 0] = "FreeRun";
    TimeMode[TimeMode["TimeOfDay"] = 1] = "TimeOfDay";
})(TimeMode = exports.TimeMode || (exports.TimeMode = {}));
var SafeTitlePattern;
(function (SafeTitlePattern) {
    SafeTitlePattern[SafeTitlePattern["Horizontal"] = 1] = "Horizontal";
    SafeTitlePattern[SafeTitlePattern["Vertical"] = 2] = "Vertical";
})(SafeTitlePattern = exports.SafeTitlePattern || (exports.SafeTitlePattern = {}));
