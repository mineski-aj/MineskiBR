    ...
    getNextChunks(props) {
        ...
        for (let i = 0; i < props.chunkCount; i++) {
            ...
            commands.push(new DataTransfer_1.DataTransferDataCommand({
                ...
                body: this.data.subarray(tslib_1.__classPrivateFieldGet(this, _DataTransferUploadBuffer_bytesSent, "f"), tslib_1.__classPrivateFieldGet(this, _DataTransferUploadBuffer_bytesSent, "f") + chunkSize - shortenBy),
            }));
